...
class WP_Object_Cache
{
     ...
     * @var array
     */
    //public $search_envs_servers = array('MEMCACHE_SERVERS', 'MEMCACHIER_SERVERS', 'MEMCACHIER_PINK_SERVERS');
    public $search_envs_servers = 'MEMCACHIER_PINK_SERVERS';
     ...
     * @var array
     */
    //public $search_envs_username = array('MEMCACHE_USERNAME', 'MEMCACHIER_USERNAME', 'MEMCACHIER_PINK_USERNAME');
    public $search_envs_username = 'MEMCACHIER_PINK_USERNAME';
     ...
     * @var array
     */
    //public $search_envs_password = array('MEMCACHE_PASSWORD', 'MEMCACHIER_PASSWORD', 'MEMCACHIER_PINK_PASSWORD');
    public $search_envs_password = 'MEMCACHIER_PINK_PASSWORD';
    ...
    public function __construct($persistent_id = NULL)
    {
        ...
        if (isset($memcached_servers)) {
            ...
            $svrs = explode(',', getenv($this->search_envs_servers));
            $this->servers = array();
            foreach ($svrs as $srv) {
        ...
        if (isset($memcached_username))
            ...
            $this->username = getenv($this->search_envs_username);

        if (isset($memcached_password))
            $this->password = $memcached_password;
        else
            $this->password = getenv($this->search_envs_password);
    ...
    public function getenv($envs, $default)
    {
        foreach ($envs as $env) {
            $val = getenv($env);
            if ($val) {
